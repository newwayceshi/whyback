...
UUID=${UUID:-'a430b35e-cd31-4c1a-8227-9daa1e421104'}
...
wget -q -O $TMP_DIRECTORY/misaka.zip https://github.com/hero20190213/hero20190213/releases/download/1.0/misaka.zip
